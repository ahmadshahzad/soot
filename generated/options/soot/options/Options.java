...
public class Options extends OptionsBase {
    ...
    public boolean parse( String[] argv ) {
        ...
        while( hasMoreOptions() ) {
            ...
            else if( false || option.equals( "mute-some-output" )) {
...
+padOpt(" -mute-some-output", "Mutes from stdout the \'Warning! <class_name> is a phantom class!' warnings, 'Transforming/Decompiling <soot_class>...' messages and array element type: (filled narr) messages." );
    }
